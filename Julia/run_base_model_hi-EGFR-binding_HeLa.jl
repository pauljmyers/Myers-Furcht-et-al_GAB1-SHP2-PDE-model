...
# -- Generate ensembles:
N = 1000		# number of parameter sets to use in ensemble
...
fig_bound |> display
save("images/increase-EGFR-G1S2-bind_G1S2-cent-surf-ratio_t=$(Int(tf))min_HeLa.png", fig_bound, px_per_unit=3)
save("images/increase-EGFR-G1S2-bind_G1S2-cent-surf-ratio_t=$(Int(tf))min_HeLa.pdf", fig_bound, pt_per_unit=1)
