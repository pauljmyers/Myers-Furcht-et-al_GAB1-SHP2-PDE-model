...
eq = [# -- Cytosolic species:
    ...
    # Active SFKs (aSFK):
      Dt(aSFK(r,t)) ~ 1e-32*D1*∇²(aSFK(r,t), r) - k10*aSFK(r,t),
...
bcs = [# -- Boundary conditions @ r = 0:
       ...
       1e-32*D1*Dr(aSFK(R,t)) ~ k9*iSFK(R,t)*2.0*(E(t)+EG2(t)+EG2G1(t)+EG2PG1(t)+EG2PG1S(t)),
    #    Dt(aSFK(R,t)) ~ (k9*iSFK(R,t)*2.0*(E(t)+EG2(t)+EG2G1(t)+EG2PG1(t)+EG2PG1S(t)),
