...
%surface species). Concentrations of proteins for HeLa cells were obtained
%from Kulak et al. (DOI: 10.1038/nmeth.2834).
...
CoSFK = numSFK*volCF; %Total concentration of SFK
numG2 = 628000.0; % HeLa copy number of GRB2
CoG2 = numG2*volCF; %Total concentration of GRB2
numG1 = 1530.0; % Copy number of GAB1
CoG1 = numG1*volCF; %Total concentration of GAB1
numS2 = 3.0e5; % HeLa copy number of SHP2 (PTPN11)
CoS2 = numS2*volCF; %Total concentration of SHP2
numEGFR = 93000.0; % HeLa copy number of EGFR
CoEGFR = numEGFR*surfCF; %Total concentration of EGFR
...
title('aSFK (HeLa protein expression)')
colormap(cmap)
xlim([0 tf])
...
title('pGAB1 (HeLa protein expression)')
colormap(cmap)
xlim([0 tf])
...
title('GAB1-SHP2 (HeLa protein expression)')
colormap(cmap)
xlim([0 tf])